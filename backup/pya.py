    ...
    if st.button('Analysis'):
        if userText:
            ...
            if len(userText.split()) <= 1:
                st.warning('Mohon masukkan lebih dari satu kata untuk analisis sentimen.') # Tampilkan Ulasan Asli
            else:
            ...
            if lang == 'id':
                ...
                if sentiment_label == 'positif':
                    col1.image('./images/b1.gif', use_column_width=True,width=100)  # Tampilkan GIF positif
                else:
                    col1.image('./images/b2.gif',  use_column_width=True,width=100)   # Tampilkan GIF negatif
