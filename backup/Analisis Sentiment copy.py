    ...
    if st.button('Analysis'):
        if userText:
            ...
            if lang == 'id':
                ...
                # Tampilkan Hasil
                st.markdown("<h3 style='color: #0284c7; font-family: Source Sans Pro, sans-serif; font-size: 28px; margin-bottom: 10px; margin-top: 50px;'>Hasil Analisis :</h3>", unsafe_allow_html=True)
