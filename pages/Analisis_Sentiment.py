...
def main(): 
    ...
    """
    **Langkah-langkah:**
    1. Masukkan ulasan produk pada kolom input di bawah.
    2. Klik tombol 'Analysis' untuk melihat hasil analisis.
    3. Aplikasi akan menampilkan rating prediksi dan label sentimen (positif/negatif).
    
    Pastikan ulasan yang dimasukkan dalam Bahasa Indonesia.
    """
)
    ...
    userText = st.text_input('Masukkan Ulasan:', placeholder='Paste Ulasan Disini..')
